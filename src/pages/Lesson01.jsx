...
function Lesson01() {
  ...
  return (
    <div className="bg-white dark:bg-[var(--color-dark-background)] text-[var(--color-dark-900)] dark:text-white">
      <div className="min-h-screen p-6 max-w-5xl mx-auto relative">
        ...
        <div className="space-y-6">
          ...
          <div>
            <p className="text-lg font-medium mb-3">
              а) обратите внимание на то, что безударные гласные произносятся,
              как под ударением, и нет смягчения твердых согласных перед{" "}
